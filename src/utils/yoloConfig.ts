 ...
 */
export async function isYOLOEnabled(): Promise<boolean> {
 ...
 */
export async function hasYOLOConfirmed(): Promise<boolean> {
  const config = await getConfig();
 ...
 * @returns {Promise<boolean>} True if successful
 */
export async function enableYOLO(): Promise<boolean> {
  const config = await getConfig();
 ...
 * @returns {Promise<boolean>} True if successful
 */
export async function disableYOLO(): Promise<boolean> {
  const config = await getConfig();
 ...
 * @returns {Promise<YOLOStatus>} YOLO status object
 */
 ...
 */
export function getYOLOSystemPrompt(): string {
  return `
 ...
 */
export function getStandardSystemPrompt(): string {
  return `
 ...
 */
export function validateCommandSafety(command: string, isYOLO = false): ValidationResult {
